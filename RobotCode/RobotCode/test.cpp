...
private:
	...
	void Move(double Forward, double Turn) {
		...
		//PID控制速度
		double P_COE=(stick.GetThrottle()+0.5)*30;//P系数 0.03
		...
		RSetDelta=-RMotorSpeed-SPEED_LIMIT*Forward-SPEED_LIMI*Turn;
		LSetDelta=LMotorSpeed-SPEED_LIMIT*Forward+SPEED_LIMI*Turn;
		RMotorSet=P_COE*RSetDelta;
		LMotorSet=P_COE*LSetDelta;
